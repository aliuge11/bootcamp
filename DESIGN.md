...
- **Harita bölmesi:** Ekranın ana gövdesi. Tek harita tam genişlik; 2-3 harita eşit genişlikte, dikey hairline ile ayrılmış tek sıra sütun. **4 harita 2x2 ızgara** (2 üstte, 2 altta, hem dikey hem yatay hairline ile ayrılmış) — dört haritayı tek sırada yan yana koymak her birini gereğinden dar bırakıyordu; 2x2'de harita en-boy oranı (yatay) genişlikten daha çok kazanıyor.
